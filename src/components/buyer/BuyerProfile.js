              ...
              <form className='space-y-4'>
                ...
                <div className='flex gap-3 pt-4'>
                  <button
                    ...
                    onClick={handleSave}
                    disabled={uploading}
                    className='bg-[#2c6449] text-white px-4 py-2 rounded hover:bg-emerald-700 disabled:opacity-50 transition'
                  >
            ...
            >
              <div className='space-y-4'>
                ...
                <button
                  ...
                  className='mt-4 bg-[#2c6449] text-white px-4 py-2 rounded hover:bg-emerald-700 transition'
                >
