...
const HelpCenter = () => {
  ...
  return (
    <section className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14'>
      <h1 className='text-2xl sm:text-3xl font-bold text-[#2c6449] mb-4'>
        Help Center
      </h1>
      <p className='text-gray-600 mb-8 text-sm sm:text-base'>
        Need help? Start with our frequently asked questions or reach out to our
        team.
      </p>
        ...
        {filteredFaqs.length > 0 ? (
          filteredFaqs.map((faq, index) => (
            <div key={index} className='border-b pb-4'>
              <h3 className='font-semibold text-[#2c6449] mb-1 text-base sm:text-lg'>
                {faq.question}
              </h3>
      ...
      {/* Contact Box */}
      <div className='mt-14 text-center bg-gray-50 p-6 sm:p-8 border rounded-lg'>
