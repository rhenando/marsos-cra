...
const RfqModal = ({ show, onClose }) => {
  ...
  const validateForm = () => {
    ...
    if (!productDetails.trim())
      newErrors.productDetails = "Product details required";
  ...
  if (showSuccessScreen) {
    return (
      <div className='fixed top-0 left-0 w-screen h-screen bg-[#2c6449]/30 flex items-center justify-center z-[9999]'>
        <svg
          className='w-16 h-16 text-[#2c6449] animate-bounce'
          fill='none'
          viewBox='0 0 24 24'
          stroke='currentColor'
        >
        ...
        <form onSubmit={handleSubmit} className='p-4 space-y-4 text-sm'>
            ...
            <div>
              ...
              <Select
                ...
                onCreateOption={(val) => {
                  ...
                  if (exists) return setSelectedSubcategory(exists);
          ...
          <div className='flex items-center space-x-2'>
            <input
              ...
              className='w-4 h-4'
            />
            <label htmlFor='shareBusinessCard'>
